...
class Mine
{
     ...
     */
    public static function genesis_block(string $data = '') : Block
    {
     ...
     * @return \BenHarold\Blockchain\Block
     */
    public static function block(string $data = '', Block $previous_block) : Block
    {
     ...
     * @return bool
     */
    public static function hash_starts_with_n_zeros(Block $block, int $n)
    {
        for ($x = 0; $x < $n; $x++) {
            if ($block->hash[$x] !== '0') {
                return false;
